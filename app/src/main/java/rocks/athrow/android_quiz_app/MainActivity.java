...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitAnswers(View view) {
        ...
        // TODO: Use an int array insted of all different array elements.
        // In XML use @string way insted of hardcoding the values.
        int answer1_score;
        int answer2_score;
        int answer3_score;
        int answer4_score;
        ...
        // Final Score
        //------------------------------------------------------------------------------------------
        // TODO: as of now you have used an int array so use for-each loop to find final score.
